// Function to catch API Request Errors
function errorHandler(error) {
    if (error.response.status === 401) {
      throw new Error('Invalid API token, Please get correct API token from submission email and exit the app to start again');
